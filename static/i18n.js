...
const i18n = {
    zh: {
        ...
        'change_icon_prompt': '输入新的图标 (Font Awesome 类名、图片URL或base64数据)',
        ...
        'tags_placeholder': '多个标签用 / 或 , 分隔，例如：前端/React/Vue',
    ...
    en: {
        ...
        'tags_label': 'Tags',
        'tags_placeholder': 'Separate tags with / or , e.g., frontend/React/Vue',
        ...
        'change_icon_prompt': 'Enter new icon (Font Awesome class, image URL, or base64 data)',
